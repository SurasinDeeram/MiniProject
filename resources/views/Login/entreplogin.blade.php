        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card" style="background-color: rgba(46, 201, 236, 0.671)">
                    ...
                    <div class="card-body">
                        <form action="{{ route('entreplogin.user') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                <label for="email">ชื่อผู้ใช้ หรือ อีเมล</label>
                        ...
                        <br>
                            <a href="{{ url('entre') }}"  class="link-gis">ลงทะเบียน</a>
                    </div>
                </div>
            </div>
        </div>
